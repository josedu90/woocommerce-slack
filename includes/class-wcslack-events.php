...
if ( ! class_exists( 'WC_Slack_Events' ) ) {
	...
	class WC_Slack_Events {
		...
		public function new_order( $order_id ) {
			...
			// Send notifications if order total is greater than or if free order notification is enabled
			if ( 0 < absint( $order->get_total() ) || ( $free_order == 'yes' ) ) {
				...
				$fields = array_merge( $fields, $order_line_items, $order_shipping, $order_attach_total );
